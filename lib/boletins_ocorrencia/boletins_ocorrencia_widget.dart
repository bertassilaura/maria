...
import 'boletins_ocorrencia_model.dart';
export 'boletins_ocorrencia_model.dart';

class BoletinsOcorrenciaWidget extends StatefulWidget {
  const BoletinsOcorrenciaWidget({super.key});

  @override
  State<BoletinsOcorrenciaWidget> createState() =>
      _BoletinsOcorrenciaWidgetState();
}

class _BoletinsOcorrenciaWidgetState extends State<BoletinsOcorrenciaWidget> {
  late BoletinsOcorrenciaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BoletinsOcorrenciaModel());
  }
