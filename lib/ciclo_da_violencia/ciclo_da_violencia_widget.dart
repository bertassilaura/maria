...
import 'ciclo_da_violencia_model.dart';
export 'ciclo_da_violencia_model.dart';

class CicloDaViolenciaWidget extends StatefulWidget {
  const CicloDaViolenciaWidget({super.key});

  @override
  State<CicloDaViolenciaWidget> createState() => _CicloDaViolenciaWidgetState();
}

class _CicloDaViolenciaWidgetState extends State<CicloDaViolenciaWidget> {
  late CicloDaViolenciaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CicloDaViolenciaModel());
  }
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'As Fases do Ciclo de Violência',
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
