...
import 'prevencao_model.dart';
export 'prevencao_model.dart';

class PrevencaoWidget extends StatefulWidget {
  const PrevencaoWidget({super.key});

  @override
  State<PrevencaoWidget> createState() => _PrevencaoWidgetState();
}

class _PrevencaoWidgetState extends State<PrevencaoWidget> {
  late PrevencaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrevencaoModel());
  }
